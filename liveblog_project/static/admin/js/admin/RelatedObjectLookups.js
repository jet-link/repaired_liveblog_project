...
// Override: 'unload' replaced with 'pagehide' to fix Permissions policy violation
'use strict';
{
    const $ = django.jQuery;
    let popupIndex = 0;
    ...
    // Use pagehide instead of unload — unload violates Permissions Policy in modern browsers
