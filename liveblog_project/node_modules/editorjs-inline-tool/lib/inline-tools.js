...
exports.UnderlineInlineTool = exports.StrongInlineTool = exports.ItalicInlineTool = void 0;
var tool_1 = __importDefault(require("./tool"));
exports.ItalicInlineTool = tool_1.default({
    sanitize: {
        em: {},
    },
    shortcut: 'CMD+I',
...
exports.StrongInlineTool = tool_1.default({
    sanitize: {
        strong: {},
    },
    shortcut: 'CMD+B',
...
exports.UnderlineInlineTool = tool_1.default({
    sanitize: {
        u: {},
    },
    tagName: 'U',
